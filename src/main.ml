...
and typeof_bop env bop e1 e2 =
  ...
  | SubF, TFloat, TFloat -> TFloat
  | MulF, TFloat, TFloat -> TFloat
...
and eval_bop bop e1 e2 =
  let round2 x = round_dfrac 2 x in
  ...
  | AddF, Int a, Int b -> Float (round2 (float_of_int a +. float_of_int b))
  | AddF, Int a, Float b -> Float (round2 (float_of_int a +. b))
  | AddF, Float a, Int b -> Float (round2 (a +. float_of_int b))
  | AddF, Float a, Float b -> Float (round2 (a +. b))
  | SubF, Int a, Int b -> Float (round2 (float_of_int a -. float_of_int b))
  | SubF, Int a, Float b -> Float (round2 (float_of_int a -. b))
  | SubF, Float a, Int b -> Float (round2 (a -. float_of_int b))
  | SubF, Float a, Float b -> Float (round2 (a -. b))
  | MulF, Int a, Int b -> Float (round2 (float_of_int a *. float_of_int b))
  | MulF, Int a, Float b -> Float (round2 (float_of_int a *. b))
  | MulF, Float a, Int b -> Float (round2 (a *. float_of_int b))
  | MulF, Float a, Float b -> Float (round2 (a *. b))
  | DivF, Int a, Int b -> Float (round2 (float_of_int a /. float_of_int b))
  | DivF, Int a, Float b -> Float (round2 (float_of_int a /. b))
  | DivF, Float a, Int b -> Float (round2 (a /. float_of_int b))
  | DivF, Float a, Float b -> Float (round2 (a /. b))
